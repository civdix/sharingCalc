...
function Home() {
  return (
    <div className="d-flex align-items-center" style={{ height: "100vh" }}>
      <div
        className="bg-dark text-light blur my-3 rounded p-2 d-flex position-relative"
      ...
      >
        <div className="float-start my-auto">
          ...
          <GiStraightPipe
            ...
            color="#414546"
            style={{ top: "0.8%", rotate: "315deg", left: "82.9%" }}
          />
          <img
            ...
            width="25%"
            className="position-absolute "
            style={{ top: "1%", rotate: "315deg", left: "-5%", zIndex: 2 }}
          />
